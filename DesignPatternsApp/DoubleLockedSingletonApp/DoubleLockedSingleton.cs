...
namespace DoubleLockedSingletonApp
{
    public class DoubleLockedSingleton
    {
        ...
        private static DoubleLockedSingleton Instance = null;
        ...
        private static void PrintTeacherDetails()
        {
            ...
            DoubleLockedSingleton fromTeacher = DoubleLockedSingleton.GetInstance();
            fromTeacher.PrintDetails("From Teacher");
        }
        private static void PrintStudentDetails()
        {
            //At the same time, Thread-2 also Calling the GetInstance() Method of the Singleton Class
            DoubleLockedSingleton fromStudent = DoubleLockedSingleton.GetInstance();
